    ...
    <div className=" text-darkBlueFont text-montserrat mb-10">
      ...
      <div className="flex flex-col">
        ...
        <select
          ...
          disabled
          className="border-[1px] border-lightGrey/[0.5] focus:ring-2 focus:bg-slate-200 rounded-2xl px-3.5 py-2.5 mt-5 w-full text-xxxs text-lightGrey/[0.75] placeholder:text-xxxs"
        >
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <input
            ...
            className="basis-1/2 mr-2 border-[1px] border-lightGrey/[0.5] focus:ring-2 focus:bg-slate-200 rounded-2xl px-3.5 py-2.5 mt-5 w-full text-base placeholder:text-xxxs"
          ></input>
          ...
          <input
            ...
            onChange={handleInputChange}
            className="basis-1/2 ml-2 border-[1px] border-lightGrey/[0.5] focus:ring-2 focus:bg-slate-200 rounded-2xl px-3.5 py-2.5 mt-5 w-full text-base placeholder:text-xxxs"
          ></input>
        </div>
